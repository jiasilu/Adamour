...
<?php if ($s5_responsive_column_increase == "enabled" && $s5_responsive == "enabled" && $s5_fixed_fluid == "%"){ ?>
	...
	@media screen and (min-width: 1300px){
		...
		#s5_left_column_wrap {
		width:<?php echo $s5_left_column_width * 1.3; ?>px !important;
		margin-right:-<?php echo ($s5_left_column_width + $s5_right_column_width) * 1.3; ?>px !important;
		}
	...
	@media screen and (min-width: 1900px){
		...
		#s5_left_column_wrap {
		width:<?php echo $s5_left_column_width * 1.6; ?>px !important;
		margin-right:-<?php echo ($s5_left_column_width + $s5_right_column_width) * 1.6; ?>px !important;
		}
		#s5_center_column_wrap_inner {
	...
	@media screen and (min-width: 2500px){
		...
		#s5_left_column_wrap {
		width:<?php echo $s5_left_column_width * 1.9; ?>px !important;
		margin-right:-<?php echo ($s5_left_column_width + $s5_right_column_width) * 1.9; ?>px !important;
		}
		#s5_center_column_wrap_inner {
...
?>
	...
	@media screen and (max-width: 970px){
		...
		#s5_right_column_wrap {
		width:<?php echo $s5_right_largest; ?>px !important;
		margin-left:-<?php echo $s5_right_largest; ?>px !important;
		}
		#s5_left_column_wrap {
		width:<?php echo $s5_left_largest; ?>px !important;
		margin-right:-<?php echo $s5_left_largest; ?>px !important;
		}
		#s5_center_column_wrap_inner {
...
<?php if ($s5_responsive_columns_small_tablet == "reduce"  && $s5_responsive == "enabled"){ ?>
	...
	@media screen and (max-width: 750px){
		...
		#s5_right_column_wrap {
		width:<?php echo $s5_right_largest * 0.8; ?>px !important;
		margin-left:-<?php echo $s5_right_largest * 0.8; ?>px !important;
		}
		#s5_left_column_wrap {
		width:<?php echo $s5_left_largest * 0.8; ?>px !important;
		margin-right:-<?php echo $s5_left_largest * 0.8; ?>px !important;
		}
		#s5_center_column_wrap_inner {
