...
function s5_rsp_width_check() {
	...
	if (document.body.offsetWidth <= 970) {
		...
		if (s5_right_width_orig > 0 || s5_right_inset_width_orig > 0) {
			...
			document.getElementById("s5_right_column_wrap").style.marginLeft = "-" + s5_rsp_right_largest_orig + "px";
		...
		if (s5_left_width_orig > 0 || s5_left_inset_width_orig > 0) {
			...
			document.getElementById("s5_left_column_wrap").style.marginRight = "-" + s5_rsp_left_largest_orig + "px";
	...
	if (document.body.offsetWidth > 970) {
		...
		if (s5_right_inset_width_orig > 0 || s5_right_width_orig > 0) {
			...
			document.getElementById("s5_right_column_wrap").style.marginLeft = "-" + (s5_right_width_orig + s5_right_inset_width_orig) + "px";
		...
		if (s5_left_inset_width_orig > 0 || s5_left_width_orig > 0) {
			...
			document.getElementById("s5_left_column_wrap").style.marginRight = "-" + (s5_left_width_orig + s5_left_inset_width_orig) + "px";
